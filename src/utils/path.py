"""
Clase: path
Py con funciones para utilidades a nivel de codigo en rutas de archivos
...
def obtener_ruta_local(nombre_objetivo="proyecto-mineria-asociacion"):
    """
...
def obtener_ruta_app(nombre_objetivo="proyecto-mineria-asociacion"):
    """
